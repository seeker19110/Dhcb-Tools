...
gần nhất, không leo lên toà nhà). ⬜ Còn: Solibri (thương mại) chưa có trên máy; và **đường Revit** dùng
`Element.LevelId` nên cùng lớp vấn đề có thể còn ở đó với cấu kiện lồng trong curtain wall/assembly —
chưa chạy thật nên chưa kết luận. Bằng chứng §41, §71 |
