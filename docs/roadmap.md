...
hổng "chấp nhận mọi quan hệ". Bằng chứng §69. ⬜ **Còn mở**: đối chiếu lại với IfcTester cho riêng thuộc
tính `relation` (bản đối chiếu 10/10 ở trên chạy trước khi có sửa này) — Solibri/IfcTester chưa có trên
máy. Bằng chứng §41 |
