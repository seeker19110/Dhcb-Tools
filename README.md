...
tests/    DhcbTools.Shared.Logic.Tests (488 test, chạy trên CI Linux) + suites/ (ca kiểm chạy trong Revit & AutoCAD)
```
...
với API Revit 2023/2024/2025 và AutoCAD 2024/2025, 488 test thuần xanh. P2 giai đoạn 7 (ống dốc, kick, BOM spool, AutoRoute,
